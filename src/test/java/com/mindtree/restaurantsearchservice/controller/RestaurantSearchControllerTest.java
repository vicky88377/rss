...
public class RestaurantSearchControllerTest {
	...
	@MockBean
	private RestaurantSearchServiceImpl restaurantSearchServiceImpl;
...
//		Pageable pageable=PageRequest.of(0, 2);
	...
	@Test
	public void TestGetRestaurantsByAreaSuccess() throws Exception {
		//
		...
		Mockito.when(restaurantSearchServiceImpl.getRestaurantByAreaAndFilterParam(Matchers.anyString(), Matchers.anyString(), Matchers.anyFloat(), Matchers.anyFloat(), Matchers.anyString(), Matchers.anyInt())).thenReturn(restaurants);
		mockMvc.perform(MockMvcRequestBuilders.get("/restaurants/search/bangalore")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.content().string(EXPECTED_RES_JSON));
	}
	...
	public void TestGetRestaurantsByAreaFailure() throws Exception {
		...
		Mockito.when(restaurantSearchServiceImpl.getRestaurantByAreaAndFilterParam(Matchers.anyString(), Matchers.anyString(), Matchers.anyFloat(), Matchers.anyFloat(), Matchers.anyString(), Matchers.anyInt())).thenReturn(null);
