...
public interface RestaurantSearchRepository extends ElasticsearchRepository<RestaurantModel, String> {
	...
	@Query("{\"bool\":{\"must\":[{\"multi_match\":{\"query\":\"?0\",\"fields\":[\"city\",\"address\",\"locality\"],\"fuzziness\":2}},{\"match\":{\"cuisen_type\":\"?1\", \"fuzziness\":2}},{\"match_phrase\":{\"cuisen_type\":\"?1\", \"fuzziness\":2}},{\"range\":{\"rating\":{\"lte\":5,\"gte\":?2}}},{\"range\":{\"minimum_order_price\":{\"gte\":?3}}}]}},\"sort\":[{\"rating\":{\"order\":\"desc\"}}]")
	...
	@Query("{\"bool\":{\"should\":[{\"multi_match\":{\"query\":\"?0\",\"fields\":[\"city\",\"address\",\"locality\"], \"fuzziness\":2}}],\"must\":[{\"match_phrase\":{\"restaurant_name\":{\"query\":\"?1\",\"boost\":3, \"fuzziness\":2}}},{\"match\":{\"restaurant_name\":{\"query\":\"?1\", \"fuzziness\":2}}}]}}")
	...
	@Query("{\"bool\":{\"must\":[{\"match\":{\"restaurant_name\":\"?0\", \"fuzziness\":2}},{\"match_phrase\":{\"restaurant_name\":\"?0\", \"fuzziness\":2}}],\"filter\":{\"geo_distance\":{\"distance\":\"?1km\",\"location\":{\"lat\":?2,\"lon\":?3}}}}}")
	...
	@Query("{\"bool\":{\"must\":[{\"match\":{\"cuisen_type\":\"?0\", \"fuzziness\":2}},{\"match_phrase\":{\"cuisen_type\":\"?0\", \"fuzziness\":2}},{\"range\":{\"rating\":{\"lte\":5,\"gte\":?1}}},{\"range\":{\"minimum_order_price\":{\"gte\":?2}}}],\"filter\":{\"geo_distance\":{\"distance\":\"?3km\",\"location\":{\"lat\":?4,\"lon\":?5}}}}},\"sort\":[{\"rating\":{\"order\":\"desc\"}}]")
